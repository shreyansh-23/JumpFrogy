onload = function () {
    ...
    let firstTime = true;
    let onGround = true;
    const game = new Phaser.Game(400, 240, Phaser.AUTO, 'mynetwork');
    ...
    const text = 'We\'ll get a jumps array as input. Each index stores the maximum islands you can jump ahead from current island. ' +
        'We need to find least number of moves needed to reach the last island and return jump to be taken on each island.<br>';
